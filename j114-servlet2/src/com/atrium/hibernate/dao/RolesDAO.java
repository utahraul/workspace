...
/**
 	* A data access object (DAO) providing persistence and search support for Roles entities.
...
public class RolesDAO extends HibernateDaoSupport  {
    ...
    public Roles findById( java.lang.Byte id) {
        ...
        try {
            Roles instance = (Roles) getHibernateTemplate()
                    .get("com.atrium.hibernate.Roles", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Roles merge(Roles detachedInstance) {
        ...
        try {
            Roles result = (Roles) getHibernateTemplate()
