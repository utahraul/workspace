 ...
 */
public class UsuariosDAO extends HibernateDaoSupport implements IUsuarios_DAO {
	...
	public static IUsuarios_DAO getFromApplicationContext(ApplicationContext ctx) {
		return (IUsuarios_DAO) ctx.getBean("UsuariosDAO");
	}
