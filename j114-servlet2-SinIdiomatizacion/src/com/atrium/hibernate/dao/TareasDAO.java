...
/**
 	* A data access object (DAO) providing persistence and search support for Tareas entities.
...
public class TareasDAO extends HibernateDaoSupport  {
    ...
    public Tareas findById( java.lang.Byte id) {
        ...
        try {
            Tareas instance = (Tareas) getHibernateTemplate()
                    .get("com.atrium.hibernate.Tareas", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Tareas merge(Tareas detachedInstance) {
        ...
        try {
            Tareas result = (Tareas) getHibernateTemplate()
