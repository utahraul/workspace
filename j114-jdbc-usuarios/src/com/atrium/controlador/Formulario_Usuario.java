...
import com.atrium.modelo.Usuario;
...
public class Formulario_Usuario extends JFrame implements ActionListener {
	...
	public void alta_Usuario() {
		...
		if (combo_roles.getSelectedItem() != null) {
			usuario_nuevo.setCodigoRol(new Integer((int) combo_roles
					.getSelectedItem()));
		} else {
			usuario_nuevo.setCodigoRol(null);
		}
		try {
			usuario_nuevo
	...
	public void baja_Usuario() {
		System.out.println("Soy baja");
	}

	public void modificar_Usuario() {
		System.out.println("Soy modi");
	}

	public void consultar_Usuario() {
		gestion_usuario = new Gestion_Usuarios();
		Usuario usuario_consultado = gestion_usuario
				.consultar_Usuario(nombre_usuario.getText());
