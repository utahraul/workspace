...
/**
 	* A data access object (DAO) providing persistence and search support for Usuarios entities.
...
public class UsuariosDAO extends HibernateDaoSupport  {
	...
	public static final String CODIGO_ROL = "codigoRol";
    ...
    public Usuarios findById( java.lang.String id) {
        ...
        try {
            Usuarios instance = (Usuarios) getHibernateTemplate()
                    .get("com.atrium.hibernate.Usuarios", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List findByCodigoRol(Object codigoRol
	) {
		return findByProperty(CODIGO_ROL, codigoRol
		);
	}
    ...
    public Usuarios merge(Usuarios detachedInstance) {
        ...
        try {
            Usuarios result = (Usuarios) getHibernateTemplate()
